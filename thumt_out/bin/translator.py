...
def main(args):
    ...
    with tf.Graph().as_default():
		...
		print(result[4][0].shape)
                data = {'enc':result[2], 'dec':result[3], 'ecdc':result[4]}
        ...
        with open(args.output+".pickle", "wb") as pickle_file:
            pickle.dump(data_list, pickle_file, pickle.HIGHEST_PROTOCOL)
